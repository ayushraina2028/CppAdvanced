...
bool hasPathSum(TreeNode* root, int targetSum) {
    ...
    else if(root->left == NULL and root->right == NULL and targetSum == root->val) return true;
    else if(root->left == NULL and root->right == NULL and targetSum != root->val) return false;
...
int main() {
    ...
    if(haspath) cout << "Path Exists !" << endl;
    else cout << "Path does not exists" << endl;
}   